  ...
  render() {
    return (
      <div className="intro-message">
        ...
        <p>Hãy kiên nhẫn với chính mình và người khác. Hành trình đi tìm kho báu sẽ không vui nếu bạn chỉ đi một mình, thế nên hãy giúp bạn bè mình cùng tiến bộ mỗi ngày nhé, mình chắc rằng ngoài kho báu ở cuối con đường, thì quá trình đi tìm kho báu sẽ giúp mỗi con người ta trưởng thành hơn. Hãy cố gắng để trở nên hoàn thiện hơn mỗi ngày và đó cũng chính là châm ngôn của goingsunny “fake it til you make it”.</p>
